      ...
      <div className="container-fluid py-5" id="family">
        <div className="container pt-5 pb-3">
          ...
          <div className="row portfolio-container">
            {[1, 2, 3].map((num) => (
              <div key={num} className="col-lg-4 col-md-6 mb-4 portfolio-item first">
                <div className="position-relative mb-2">
                  <img className="img-fluid w-100" src={`/assets/img/groomsmen-${num}.jpg`} alt="Groomsmen" />
            ...
            {[1, 2, 3].map((num) => (
              <div key={num} className="col-lg-4 col-md-6 mb-4 portfolio-item second">
                <div className="position-relative mb-2">
                  <img className="img-fluid w-100" src={`/assets/img/bridesmaid-${num}.jpg`} alt="Bridesmaid" />
                  <div className="bg-secondary text-center p-4">
                    <h4 className="mb-3">Full Name</h4>
                    <p className="text-uppercase">Best Friend</p>
                    <div className="d-inline-block">
